#
# BIMserver 1.5.147 on latest Tomcat 8.5
#
...
RUN wget https://github.com/opensourceBIM/BIMserver/releases/download/v1.5.147/bimserverwar-1.5.147.war \
	-O /var/www/localhost/ROOT.war


# For local build
# ADD ./bimserverwar-1.5.147.war /var/www/localhost/ROOT.war
