#
# BIMserver 1.5.138 on latest Tomcat 8.5
#
...
RUN wget https://github.com/opensourceBIM/BIMserver/releases/download/v1.5.138/bimserverwar-1.5.138.war \
	-O /var/www/localhost/ROOT.war


# For local build
# ADD ./bimserverwar-1.5.138.war /var/www/localhost/ROOT.war
